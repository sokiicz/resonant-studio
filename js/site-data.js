...
window.SITE_DATA = {
  ...
  apps: [
    ...
    },
    {
      id: 'undertow',
      name: 'Undertow',
      shortDesc: 'A music composition system for an AI that thinks in bass lines.',
      ...
      releaseDate: null,
      updates: [
        { date: '2026-03-09', note: 'Music composition engine scaffolded', label: 'Development started' },
      ],
    },
  ],
